    ...
    t = function (t) {
        ...
        var r = {
          ...
          getRegexMask: function () {
            for (var t, a, s, r, n = [], o = 0; o < e.length; o++)
              (t = i.translation[e.charAt(o)]) ? (a = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""),
                s = t.optional,
                (t = t.recursive) ? (n.push(e.charAt(o)),
                  r = {
                    digit: e.charAt(o),
                    pattern: a
          ...
          calculateCaretPosition: function (t) {
            ...
            if (t !== e) {
              ...
              s > o ? s = 10 * e : n >= s && n !== o ? r.maskDigitPosMapOld[s] || (n = s,
                s = s - (p - c) - t,
                r.maskDigitPosMap[s] && (s = n)) : s > n && (s = s + (c - p) + l)
            }
            return s
          },
          ...
          getMasked: function (t, a) {
            ...
            for (; _();) {
              var h = e.charAt(c)
                , g = l.charAt(d)
                , y = i.translation[h];
              y ? (g.match(y.pattern) ? (o[k](g),
                y.recursive && (-1 === b ? b = c : c === v && c !== b && (c = b - m),
                  v === b && (c -= m)),
                c += m) : g === n ? (f--,
                  n = void 0) : y.optional ? (c += m,
                    d -= m) : y.fallback ? (o[k](y.fallback),
                      c += m,
                      d -= m) : r.invalid.push({
                        p: d,
                        v: g,
      ...
      var e = function () {
        var e = t(this)
          , r = {}
          , n = e.attr("data-mask");
        if (e.attr("data-mask-reverse") && (r.reverse = !0),
      ...
      t.fn.mask = function (e, r) {
        ...
        var l = function () {
          if (s(this, e, r))
            return t(this).data("mask", new a(this, e, r))
        };
        return t(this).each(l),
          n && "" !== n && i && (clearInterval(t.maskWatchers[n]),
    ...
    t = jQuery,
      ...
      e = {
          ...
          for (let n in s) {
            ...
            for (let a in s[n]) {
              ...
              if ("sbName" === a && (c.append(`<span>${s[n][a]}</span>`),
                p.val(s[n][a])),
                "sbSize" === a && void 0 !== s[n][a] && (c.children("span").append(`<span class="smart-basket__product-size"> Размер: ${s[n][a]}</span>`),
                  d.val(s[n][a])),
                "sbPrice" === a && (_.html(s[n][a]),
                  h.val(s[n][a])),
                "sbPriceCommon" === a) {
                let t = +s[n][a];
                y.val(+t.toFixed(2))
              }
              "sbQuantity" === a && (v.val(s[n][a]),
                k.val(s[n][a]))
            }
            f.click(function (a) {
              a.preventDefault();
              ...
              b.click(function (a) {
                ...
                n >= 1 ? (o = i * ++n,
                  ...
                  e.updateBasket(s, r, n, o),
                  e.getSmartBasketMinState(s, "updateSmartBasketMin"),
                  e.commonResult(s, "updateCommonResult")) : n = 1,
                  h.val(i),
                  y.val(+o.toFixed(2)),
                  v.val(n)
              }),
        ...
        stateBasket: function () {
          let s, r, n, i, o = e.getProducts() || {}, l = t("<div>").attr({
            class: "smart-basket"
          }), c = t("." + a.buttonAddToBasket);
          if (localStorage.getItem(a.localStorageName),
            ...
            s = t("<input>").attr({
              ...
              o.click(function (e) {
                e.preventDefault(),
                  ...
                  (i = +t(this).parents("." + a.productElement).find("." + s.attr("class")).val()) >= 1 ? (i++,
                    r.val(i),
                    n.attr("data-sb-product-quantity", i)) : (r.val(1),
                      n.attr("data-sb-product-quantity", 1))
          ...
          if (a.productSize && a.productPrice) {
            ...
            console.log("Заполните параметры productSize и productPrice");
            ...
            c.click(function () {
              ...
              }
              {
                ...
                i.sbId = n,
                  ...
                  i.sbPrice.toFixed(2),
                  a.productQuantityWrapper ? (i.sbPriceCommon = +t(this).attr("data-sb-product-price") * t(this).parents("." + a.productElement).find("." + s.attr("class")).val(),
                    i.sbPriceCommon.toFixed(2)) : (i.sbPriceCommon = +t(this).attr("data-sb-product-price") * +t(this).data("sbProductQuantity"),
        ...
        getSmartBasketMinState: function (s, r) {
          ...
          r ? (t("." + l.attr("class")).html(""),
            t("." + l.attr("class")).html(n)) : (l.html(n),
            ...
            m.click(function (t) {
              ...
              if (a.nameIsRequired && a.telIsRequired && a.emailIsRequired) {
                if ("" === l.val() || "" === i.val() || "" === p.val() || r(s))
                  return "" === l.val() && l.parent().addClass("smart-basket__input-wrapper_error"),
        ...
        alertBlock: function (a) {
          ...
          let p = e.getProducts() || {};
          return e.getModalBasket(c, p),
            "inBasket" === a && (n.html('\n\t\t\t\t<svg height="100" viewBox="0 0 128 128" width="100" xmlns="http://www.w3.org/2000/svg"><g id="Layer_2" data-name="Layer 2"><circle cx="64" cy="64" fill="#a7adf0" r="62.25"/><circle cx="64" cy="64" fill="#fff5cc" r="52.25"/><path d="m57.531 86.928-25.847-25.848 7.07-7.071 18.777 18.777 31.715-31.714 7.07 7.071z" fill="#57a4ff"/><g fill="#231f20"><path d="m64 0a64 64 0 1 0 64 64 64.072 64.072 0 0 0 -64-64zm0 124.5a60.5 60.5 0 1 1 60.5-60.5 60.569 60.569 0 0 1 -60.5 60.5z"/><path d="m100.1 99.278c-1.01 1.032-2.073 2.031-3.16 2.968a1.75 1.75 0 0 0 2.286 2.651c1.162-1 2.3-2.069 3.376-3.172a1.75 1.75 0 1 0 -2.5-2.447z"/><path d="m64 10a54 54 0 0 0 0 108 53.419 53.419 0 0 0 23.035-5.163 1.75 1.75 0 1 0 -1.5-3.163 49.958 49.958 0 0 1 -21.535 4.826 50.528 50.528 0 1 1 43.933-25.618 1.75 1.75 0 1 0 3.043 1.731 53.985 53.985 0 0 0 -46.976-80.613z"/><path d="m39.991 52.771a1.75 1.75 0 0 0 -2.474 0l-7.071 7.072a1.75 1.75 0 0 0 0 2.474l25.848 25.849a1.749 1.749 0 0 0 2.475 0l38.785-38.786a1.751 1.751 0 0 0 0-2.475l-7.071-7.071a1.748 1.748 0 0 0 -2.474 0l-30.478 30.477-9.3-9.3a1.75 1.75 0 0 0 -2.474 2.475l10.537 10.537a1.8 1.8 0 0 0 2.475 0l30.477-30.477 4.6 4.6-36.315 36.308-23.373-23.374 5.833-5.834a1.749 1.749 0 0 0 0-2.475z"/></g></g></svg>\n\t\t\t\t'),
              i.text("Товар добавлен в корзину")),
            "alreadyAdded" === a && (n.html('\n\t\t\t\t<svg height="100" viewBox="0 0 64 64" width="100" xmlns="http://www.w3.org/2000/svg"><g id="buy_&#xB7;_ecommerce_&#xB7;_shopping_&#xB7;_pay_&#xB7;_cart" data-name="buy &#xB7; ecommerce &#xB7; shopping &#xB7; pay &#xB7; cart"><path d="m58 53h-52v-32a2 2 0 0 1 2-2h48a2 2 0 0 1 2 2z" fill="#004fac"/><path d="m10 23h44v26h-44z" fill="#ffcd00"/><path d="m50 23v8a16 16 0 0 1 -16 16h-24v2h44v-26z" fill="#ebbf00"/><path d="m61 53v4a4 4 0 0 1 -4 4h-50a4 4 0 0 1 -4-4v-4z" fill="#58595b"/><path d="m29 57h6a2 2 0 0 0 2-2v-2h-10v2a2 2 0 0 0 2 2z" fill="#d1d3d4"/><circle cx="42" cy="44" fill="#9bc9ff" r="1"/><circle cx="47" cy="44" fill="#9bc9ff" r="1"/><path d="m28 43v-10l4 1v-4l-3.983-1h-2.017a3 3 0 0 1 -6 0h-2.025l-3.975 1v4l4-1v10z" fill="#ed1c24"/><path d="m51 11a10 10 0 1 0 10 10 10 10 0 0 0 -10-10z" fill="#7ed63e"/><path d="m51 11a10.029 10.029 0 0 0 -1.5.125 9.993 9.993 0 0 1 .039 19.756 9.907 9.907 0 0 0 1.461.119 10 10 0 0 0 0-20z" fill="#6ebb36"/><circle cx="41.556" cy="44" fill="#4e901e" r="1.556"/><circle cx="46.444" cy="44" fill="#4e901e" r="1.556"/><path d="m48.613 35h-7.355l-.266-2.124a1 1 0 0 0 -.992-.876h-2a1 1 0 0 0 0 2h1.117l.766 6.124a1 1 0 0 0 .992.876h6.4a1 1 0 0 0 .949-.684l1.333-4a1 1 0 0 0 -.944-1.316z" fill="#5eac24"/><path d="m49.293 24.707a1 1 0 0 0 1.414 0l5.657-5.657a1 1 0 0 0 -1.414-1.414l-4.95 4.95-2.122-2.122a1 1 0 0 0 -1.414 1.414z" fill="#f1f2f2"/><path d="m34.586 39h-2.586a1 1 0 0 0 0 2h2.586l-.414.414a1 1 0 1 0 1.414 1.414l2.121-2.121a1 1 0 0 0 0-1.414l-2.121-2.121a1 1 0 0 0 -1.414 1.414z" fill="#ff5023"/></g></svg>\n\t\t\t\t'),
